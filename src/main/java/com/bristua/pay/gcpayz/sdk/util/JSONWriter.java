package com.bristua.pay.gcpayz.sdk.util;

import com.bristua.pay.gcpayz.sdk.ApiField;
import com.bristua.pay.gcpayz.sdk.ApiListField;
...
public class JSONWriter {
    ...
    private void date(Date date) {
        if (this.format == null) {
            this.format = new SimpleDateFormat(GcPayzSDK.DATE_TIME_FORMAT);
            this.format.setTimeZone(TimeZone.getTimeZone(GcPayzSDK.DATE_TIMEZONE));
        }
        add("\"");
