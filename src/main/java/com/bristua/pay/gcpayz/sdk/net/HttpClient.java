...
public abstract class HttpClient {
     ...
     */
    public abstract APIGcPayzResponse request(APIGcPayzRequest request) throws GcPayzException;

    /**
     * 发送请求到GcPayz的API(支持重试)
     * @param request
     * @return
     * @throws GcPayzException
     */
    public APIGcPayzResponse requestWithRetries(APIGcPayzRequest request) throws GcPayzException {
        APIConnectionException requestException = null;
        APIGcPayzResponse response = null;
        int retry = 0;
    ...
    protected static String buildUserAgentString(String version) {
        return String.format("GcPayzSDK/v1 JavaBindings/%s", version);
    }

    protected static String buildXGcPayzClientUserAgentString(String version) {
        ...
        propertyMap.put("publisher", "GcPayzSDK");
        return JSON.toJSONString(propertyMap);
    }

    private boolean shouldRetry(
            int numRetries, GcPayzException exception, APIGcPayzRequest request, APIGcPayzResponse response) {
