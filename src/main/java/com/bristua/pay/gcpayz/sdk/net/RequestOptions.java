...
public class RequestOptions {
    ...
    public static RequestOptions getDefault(String uri, String version) {
        return new RequestOptions(
                uri,
                version,
                GcPayzSDK.DEFAULT_SIGN_TYPE,
                GcPayzSDK.appId,
                GcPayzSDK.apiKey,
                GcPayzSDK.getConnectTimeout(),
                GcPayzSDK.getReadTimeout(),
                GcPayzSDK.getMaxNetworkRetries(),
                GcPayzSDK.getAcceptLanguage());
    }
    ...
    public static class RequestOptionsBuilder {
        ...
        public RequestOptionsBuilder() {
            this.signType = GcPayzSDK.DEFAULT_SIGN_TYPE;
            this.appId = GcPayzSDK.appId;
            this.apiKey = GcPayzSDK.apiKey;
            this.connectTimeout = GcPayzSDK.getConnectTimeout();
            this.readTimeout = GcPayzSDK.getReadTimeout();
            this.maxNetworkRetries = GcPayzSDK.getMaxNetworkRetries();
            this.acceptLanguage = GcPayzSDK.getAcceptLanguage();
        }
