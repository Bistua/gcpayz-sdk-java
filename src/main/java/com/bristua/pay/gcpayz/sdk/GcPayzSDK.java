 ...
 */
public abstract class GcPayzSDK {

    public static final String LIVE_API_BASE = "http://127.0.0.1";
    ...
    public static void setAcceptLanguage(String acceptLanguage) {
        GcPayzSDK.acceptLanguage = acceptLanguage;
    }
}
